...
/// Persistence layer for the core gate flow.
/// SharedPreferences for non-sensitive flags; FlutterSecureStorage for URLs.
class DataVault {
  // Keys — unique tb.gate.* prefix for TowerBuilding
  static const _kMode        = 'tb.gate.mode';
  static const _kPushCooldown = 'tb.gate.push.cooldown';
  static const _kPushConsent  = 'tb.gate.push.consent';
  static const _kSavedUrl    = 'tb.gate.url';
  static const _kUrlTtl      = 'tb.gate.url.ttl';
  static const _kOneShotUrl  = 'tb.gate.push.oneshot';
  ...
  LaunchMode readMode() => LaunchMode.fromKey(_prefs.getString(_kMode));
