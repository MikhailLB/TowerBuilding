...
class LocalStore {
  static const String _kRoute = 'tbld.rt';
  static const String _kCachedTarget = 'tbld.tgt.v';
  static const String _kCachedTargetTtl = 'tbld.tgt.ts';
  static const String _kPushCooldown = 'tbld.psh.cd';
  static const String _kPushConsent = 'tbld.psh.ok';
  static const String _kPushOneShot = 'tbld.psh.os';
  ...
  LaunchMode readRoute() => LaunchMode.decode(_prefs.getString(_kRoute));

  Future<void> writeRoute(LaunchMode route) async {
